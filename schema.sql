...
-- Создаётся автоматически при запуске сервера (server/db.ts)
-- Этот файл — справочный
...
CREATE INDEX IF NOT EXISTS idx_comment_likes_c ON comment_likes(comment_id);
